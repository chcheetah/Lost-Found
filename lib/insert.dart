            ...
            children: [
              ListView(
                ...
                children: [
                  ...
                  Container(child: Text("\n"),),
                  TextField(controller: ide,maxLength: 4,decoration: InputDecoration(border: OutlineInputBorder(),hintText: 'Item ID'),keyboardType: TextInputType.number,),
                  ...
                  TextField(controller: date, maxLength: 10,decoration: InputDecoration(border: OutlineInputBorder(),hintText: 'Last Date seen? (YYYY-MM-DD)'),keyboardType: TextInputType.datetime,),
